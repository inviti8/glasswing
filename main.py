    ...
    def maximize_browser():
        ui.run_javascript("""
            (function() {
                ...
                overlay.style.cssText = 'position:fixed;top:0;left:0;width:100vw;height:100vh;z-index:99999;background:#000;display:flex;flex-direction:column;overflow:hidden;';
                ...
                clone.style.cssText = 'width:100%;border:none;flex:1;';
                clone.setAttribute('scrolling', 'yes');
